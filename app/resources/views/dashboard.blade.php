                ...
                @else
                    ...
                    <section>
                        <div class="w-full bg-white rounded-lg px-0 py-3">
                            ...
                            @if ($detail == null)
                                <div class="md:mx-auto w-full md:max-w-xl bg-red-100 py-3 px-4 rounded-lg">
                                    <p class="font-medium text-lg text-red-600 text-center">
                                        Harap Isi Data Sekolah Terlebih Dahulu
                                    </p>
                                </div>
                            @else
                                <!-- Detail Not Null -->
                                <div class="grid md:grid-cols-2 grid-cols-1 gap-4">
                                    ...
                                    <div class="w-full border grid grid-cols-1 rounded-md">
                                        ...
                                        <div class="inline-flex px-4 py-3 gap-x-2"
                                            title="Tanggal Berdidi Sekolah/Madrasah">
                                            <svg class="w-6 h-6 text-slate-400" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 24 24" fill="currentColor">
                                                <path
                                    ...
                                    <div class="w-full border grid grid-cols-1 rounded-md">
                                        ...
                                        <div class="inline-flex px-4 py-3 gap-x-2"
                                            title="Kepala Yayasan Sekolah/Madrasah">
                                            <svg class="w-6 h-6 text-slate-400" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 24 24" fill="currentColor">
                                                <path
                                                    d="M20 22H18V20C18 18.3431 16.6569 17 15 17H9C7.34315 17 6 18.3431 6 20V22H4V20C4 17.2386 6.23858 15 9 15H15C17.7614 15 20 17.2386 20 20V22ZM12 13C8.68629 13 6 10.3137 6 7C6 3.68629 8.68629 1 12 1C15.3137 1 18 3.68629 18 7C18 10.3137 15.3137 13 12 13ZM12 11C14.2091 11 16 9.20914 16 7C16 4.79086 14.2091 3 12 3C9.79086 3 8 4.79086 8 7C8 9.20914 9.79086 11 12 11Z">
                                        ...
                                        <div class="inline-flex px-4 py-3 gap-x-2"
                                            title="Nomor Statisik Sekolah/Madrasah">
                                            <svg class="w-6 h-6 text-slate-400" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 24 24" fill="currentColor">
                                                <path
                                        ...
                                        <div class="inline-flex px-4 py-3 gap-x-2"
                                            title="Sertifikat BPHNU Sekolah/Madrasah">
                                            <svg class="w-6 h-6 text-slate-400" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 24 24" fill="currentColor">
                                                <path
                                            ...
                                            <div class="flex justify-between items-start w-full">
                                                <div class="flex-col items-center">
                                                    <div class="flex items-center mb-1">
                                                        ...
                                                        <svg data-popover-target="chart-info"
                                                        ...
                                                        <div data-popover id="chart-info" role="tooltip"
                                                            ...
                                                            <div class="p-3 space-y-2">
                                                                ...
                                                                <p>For each date bucket, the all-time volume of activities
                                                                    is
                                                                    calculated. This
                                                                    means that activities in period n contain all activities
                                                                    up
                                                                    to period n,
                                                    ...
                                                    <div id="dateRangeDropdown"
                                                        ...
                                                        <div class="p-3" aria-labelledby="dateRangeButton">
                                                            <div date-rangepicker datepicker-autohide
                                                                ...
                                                                <span
                                                                    class="mx-2 text-gray-500 dark:text-gray-400">to</span>
                                                                <div class="relative">
                                                                    <div
                                                                        class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                                                                        <svg class="w-4 h-4 text-gray-500 dark:text-gray-400"
                                                ...
                                                <div class="flex justify-end items-center">
                                                    <button id="widgetDropdownButton"
                                            ...
                                            <div class="grid grid-cols-2">
                                                <dl class="flex items-center">
                                                    <dt class="text-gray-500 dark:text-gray-400 text-sm font-normal me-1">
                                                        Money
                                                        spent:</dt>
                                                    <dd class="text-gray-900 text-sm dark:text-white font-semibold">$3,232
                                                    </dd>
                                                </dl>
                                                <dl class="flex items-center justify-end">
                                                    <dt class="text-gray-500 dark:text-gray-400 text-sm font-normal me-1">
                                                        Conversion rate:</dt>
                                                    <dd class="text-gray-900 text-sm dark:text-white font-semibold">1.2%
                                                    </dd>
                                                </dl>
                                            </div>
