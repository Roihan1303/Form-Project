...
<body>
    <section class="bg-slate-300">
        <div class="flex md:flex-row w-full md:max-w-6xl mx-auto md:h-screen md:py-20">
            <div class="bg-white w-1/2 rounded-s-xl p-4 flex justify-center items-center ">
                <div class="bg-slate-200 w-full h-full rounded-lg flex md:flex-col gap-y-4">
            ...
            <div class="md:w-1/2 flex flex-col items-center justify-center bg-white rounded-e-xl px-4 ">
                <p class="flex items-center mb-6 px-4 text-2xl font-semibold text-gray-900 text-center">
                    Pendataan Sekolah/Madrasah LP Ma'arif NU
                    Kota Malang
                    2024
                </p>
                <div class="w-full rounded-lg md:mt-0 sm:max-w-xl">
