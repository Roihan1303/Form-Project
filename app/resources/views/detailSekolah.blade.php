...
@section('content')
    ...
    @if ($detail == null)
        <section>
            <div class="w-full bg-white rounded-lg px-4 py-3 space-y-2">
                <h2 class="font-semibold md:text-3xl md:ps-4">
                    {{ $sekolah->nama }}
                </h2>
                <div class="md:w-96 w-full bg-red-100 mx-auto py-3 px-4 mb-5 rounded-lg">
                    <p class="font-medium text-base text-red-600 text-center">
                        Profil Sekolah ini Belum Dilengkapi!
                    </p>
                </div>
            </div>
        </section>
                                    ...
                                    <li
                                        ...
                                        <div class="flex items-center ps-3">
                                            <input id="horizontal-list-radio-license" type="radio" value=""
                                                name="list-radio" {{ $detail->kurikulum == 'K13' ? 'checked' : '' }}
                                                disabled
                                    ...
                                    <li class="w-full dark:border-gray-600">
                                        <div class="flex items-center ps-3">
                                            <input id="horizontal-list-radio-passport" type="radio" value=""
                                                name="list-radio" {{ $detail->kurikulum == 'IKM' ? 'checked' : '' }}
                                                disabled
                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
    ...
    @endif
    {{-- <script src="{{ asset('assets/js/guru_jml.js') }}"></script> --}}
@endsection
